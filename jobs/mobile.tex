\skills{
  \cvskill{Mobile Apps Development}\cvskill{Back-End}
  \smallskip

  \cvskill{Databases}\cvskill{REST APIs}\cvskill{UI Design}

  \divider

  \cvskill{Android}\cvskill{SDK}\cvskill{Android Studio}\cvskill{Git}
  \smallskip

  \cvskill{Java}\cvskill{XML}\cvskill{JSON}\cvskill{Flutter}\cvskill{Dart}
  \smallskip

  \cvskill{SQL}\cvskill{Firebase}\cvskill{Python}\cvskill{JavaScript}
}
